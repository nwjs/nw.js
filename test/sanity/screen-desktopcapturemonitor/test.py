...
def assert_event_fired(event_name):
    ...
    assert 'success' in driver.find_element(By.ID, event_name).get_attribute('innerHTML')
...
try:
    ...
    print('startMonitor')
    driver.find_element(By.ID, 'startMonitor').click()
    print('newWindow')
    driver.find_element(By.ID, 'newWindow').click()
    ...
    driver.switch_to.window('mypopup')
    driver.find_element(By.ID, 'changeTitle').click()
    ...
    print('get result')
    driver.switch_to.window(base_window)
    driver.find_element(By.ID, 'stopMonitor').click()
