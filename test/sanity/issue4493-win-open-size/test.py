...
try:
    ...
    size = driver.find_element(By.ID, 'size').get_attribute('innerHTML')
    print('open size %s' % size)
    driver.find_element(By.ID, 'resize-window').click()
    size = driver.find_element(By.ID, 'resize').get_attribute('innerHTML')
