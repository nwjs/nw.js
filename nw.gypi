  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/browser/computed_hashes.cc',
        'src/browser/computed_hashes.h',
        'src/browser/content_hash_fetcher.cc',
        'src/browser/content_hash_fetcher.h',
        'src/browser/content_hash_reader.cc',
        'src/browser/content_hash_reader.h',
        'src/browser/content_hash_tree.cc',
        'src/browser/content_hash_tree.h',
        'src/browser/content_verifier.cc',
        'src/browser/content_verifier.h',
        'src/browser/content_verifier_io_data.cc',
        'src/browser/content_verifier_io_data.h',
        'src/browser/content_verify_job.cc',
        'src/browser/content_verify_job.h',
        'src/browser/verified_contents.cc',
        'src/browser/verified_contents.h',
        'src/browser/nw_content_verifier_delegate.cc',
        'src/browser/nw_content_verifier_delegate.h',
        'src/browser/file_protocol.cc',
        'src/browser/file_protocol.h',
