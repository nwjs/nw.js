...
#        'src/browser/shell_javascript_dialog_gtk.cc',
 ...
 #       'src/browser/shell_login_dialog_gtk.cc',
        ...
        'src/browser/interstitials/security_interstitial_page.cc',
        'src/browser/interstitials/security_interstitial_page.h',
        'src/browser/ssl/ssl_blocking_page.cc',
        'src/browser/ssl/ssl_blocking_page.h',
        'src/browser/ssl/ssl_error_classification.cc',
        'src/browser/ssl/ssl_error_classification.h',
        'src/browser/ssl/ssl_error_handler.cc',
        'src/browser/ssl/ssl_error_handler.h',
        'src/browser/ssl/ssl_error_info.cc',
        'src/browser/ssl/ssl_error_info.h',
        'src/browser/ssl/nw_ssl_host_state_delegate.cc',
        'src/browser/ssl/nw_ssl_host_state_delegate.h',
