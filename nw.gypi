  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/shell_devtools_delegate.cc',
        'src/shell_devtools_delegate.h',
        'src/shell_download_manager_delegate.cc',
        'src/shell_download_manager_delegate.h',
        'src/shell_javascript_dialog_creator.cc',
        'src/shell_javascript_dialog_creator.h',
        'src/shell_javascript_dialog_gtk.cc',
        'src/shell_javascript_dialog_mac.mm',
        'src/shell_javascript_dialog_win.cc',
        'src/shell_javascript_dialog.h',
        'src/shell_login_dialog_gtk.cc',
        'src/shell_login_dialog_mac.mm',
        'src/shell_login_dialog.cc',
        'src/shell_login_dialog.h',
