...
## Downloads
* **v0.112.0:** (May 24th, 2026, based off of Node.js v26.1.0, Chromium 149) : [release notes](https://nwjs.io/blog/v0.112.0/)
 **NOTE** You might want the **SDK build**. Please read the release notes.
 * Linux: [64bit](https://dl.nwjs.io/v0.112.0/nwjs-v0.112.0-linux-x64.tar.gz) / [arm64](https://dl.nwjs.io/v0.112.0/nwjs-v0.112.0-linux-arm64.tar.gz)
 * Windows: [32bit](https://dl.nwjs.io/v0.112.0/nwjs-v0.112.0-win-ia32.zip) / [64bit](https://dl.nwjs.io/v0.112.0/nwjs-v0.112.0-win-x64.zip)
 * Mac 10.10+: [64bit](https://dl.nwjs.io/v0.112.0/nwjs-v0.112.0-osx-arm64.zip)
