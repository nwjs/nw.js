...
## Downloads
* **v0.93.0:** (Oct 22, 2024, based off of Node.js v22.7.0, Chromium 130.0.6723.59) : [release notes](https://nwjs.io/blog/v0.93.0/)  
 **NOTE** You might want the **SDK build**. Please read the release notes.
 * Linux: [32bit](https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-linux-ia32.tar.gz) / [64bit](https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-linux-x64.tar.gz)
 * Windows: [32bit](https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-win-ia32.zip) / [64bit](https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-win-x64.zip)
 * Mac 10.10+: [64bit](https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-osx-arm64.zip)
