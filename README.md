...
## Downloads
* **v0.114.0:** (July 24th, 2026, based off of Node.js v26.1.0, Chromium 151) : [release notes](https://nwjs.io/blog/v0.114.0/)
 **NOTE** You might want the **SDK build**. Please read the release notes.
 * Linux: [64bit](https://dl.nwjs.io/v0.114.0/nwjs-v0.114.0-linux-x64.tar.gz) / [arm64](https://dl.nwjs.io/v0.114.0/nwjs-v0.114.0-linux-arm64.tar.gz)
 * Windows: [32bit](https://dl.nwjs.io/v0.114.0/nwjs-v0.114.0-win-ia32.zip) / [64bit](https://dl.nwjs.io/v0.114.0/nwjs-v0.114.0-win-x64.zip)
 * Mac 10.10+: [64bit](https://dl.nwjs.io/v0.114.0/nwjs-v0.114.0-osx-arm64.zip)
