...
## Downloads
* **v0.76.1:** (May 16, 2023, based off of Node.js v20.1.0, Chromium 113.0.5672.64) : [release notes](https://nwjs.io/blog/v0.76.1/)  
 **NOTE** You might want the **SDK build**. Please read the release notes.
 * Linux: [32bit](https://dl.nwjs.io/v0.76.1/nwjs-v0.76.1-linux-ia32.tar.gz) / [64bit](https://dl.nwjs.io/v0.76.1/nwjs-v0.76.1-linux-x64.tar.gz)
 * Windows: [32bit](https://dl.nwjs.io/v0.76.1/nwjs-v0.76.1-win-ia32.zip) / [64bit](https://dl.nwjs.io/v0.76.1/nwjs-v0.76.1-win-x64.zip)
 * Mac 10.10+: [64bit](https://dl.nwjs.io/v0.76.1/nwjs-v0.76.1-osx-x64.zip)
